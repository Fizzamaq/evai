...
require_once __DIR__ . '/../classes/User.class.php'; // Required for User class methods like isVendor

$vendor = new Vendor($pdo); // Pass PDO to constructor
$user = new User($pdo);     // Pass PDO to constructor
...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETS_PATH ?>css/dashboard.css"> <link rel="stylesheet" href="<?= ASSETS_PATH ?>css/vendor.css">   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
